...
import{CssBaseline , Grid, grid }from '@material-ui/core'
    ...
    <>
        ...
        <Grid container spacing ={3} style ={{width: "100%"}}>
          <Grid item xs={12} md={4}>
            <List type={type} setType={setType} rating={rating} setRaiting={setRaiting} loading ={loading }ChildClick={ChildClick} places={places} />
          </Grid>
          <Grid item xs={12} md={8}>
            <Map places ={places} setChildClick={setChildClick} setcoordinates={setcoordinates} setbounds={setbounds} coordinates={coordinates}/>
          </Grid>
        </Grid >
        <footer className="text-center lg:text-left bg-gray-100 text-gray-600">
  <div classNameName="flex justify-center items-center lg:justify-between p-6 border-b border-gray-300">
    <div classNameName="mr-12 hidden lg:block">
